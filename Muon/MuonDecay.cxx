...
namespace larlite {
  ...
  bool MuonDecay::initialize() {
    ...
    electron_E = new TH1D("electron_energy", "title;x;y", 100, 0, 100);
  ...
  bool MuonDecay::analyze(storage_manager* storage) {
    ...
    while ( c < event_shower->size()){
      ...
      c++;
      if (shower.PdgCode() != 11 || shower.MotherPdgCode()  != 13 || shower.Process() != "muMinusCaptureAtRest") continue;
      electron_E->Fill(shower.Start().E());
